...
### 👉 **[点击直接使用](https://weibai.onrender.com)**

**已部署到云端，手机电脑直接访问，无需安装！**

- 手机打开后 → 添加到主屏幕 → 桌面出现「味白」图标
- 电脑打开 → 直接在浏览器使用
- **数据隔离**：每个设备自动生成唯一 ID，A 和 B 互不可见
...
1. 打开 Chrome 访问 **https://weibai.onrender.com**
2. 底部自动弹出 **"添加到主屏幕"** → 点击添加
3. 桌面出现「味白」图标，像原生 App 一样打开
4. 如果没弹出：点右上角 `⋮` → 添加到主屏幕

#### iPhone 手机（Safari）

1. 打开 Safari 访问 **https://weibai.onrender.com**
2. 点底部中间 **分享按钮**（方框+箭头）
3. 向下滑动 → **"添加到主屏幕"**
4. 点右上角添加 → 桌面出现「味白」图标
